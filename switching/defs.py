...
TABLA_82 = [
    ('01', u'ATENCION INCORRECTA'),
    ('02', u'PRIVACIDAD DE LOS DATOS'),
    ('03', u'INCIDENCIA EN EQUIPOS DE MEDIDA'),
    ('04', u'DAÑOS ORIGINADOS POR EQUIPO DE MEDIDA'),
    ('05', u'CONTADOR EN FACTURA NO CORRESPONDE CON INSTALADO'),
    ('06', u'CONTRATOS ATR QUE NO SE FACTURAN'),
    ('07', u'CUPS NO PERTENECE A COMERCIALIZADORA O NO VIGENTE EN PERIODO DE'
           u' FACTURA'),
    ('08', u'DISCONFORMIDAD CON CONCEPTOS FACTURADOS'),
    ('09', u'DISCONFORMIDAD CON LECTURA FACTURADA'),
    ('10', u'DISCONFORMIDAD EN FACTURA ANOMALÍA / FRAUDE'),
    ('11', u'RECLAMACIÓN FACTURA PAGO DUPLICADO'),
    ('12', u'REFACTURACION NO RECIBIDA'),
    ('13', u'DISCONFORMIDAD CON CAMBIO DE SUMINISTRADOR'),
    ('14', u'REQUERIMIENTO DE FIANZA / DEPÓSITO DE GARANTÍA'),
    ('15', u'RETRASO CORTE DE SUMINISTRO'),
    ('16', u'RETRASO EN PLAZO ACEPTACIÓN'),
    ('17', u'RETRASO EN PLAZO ACTIVACIÓN'),
    ('18', u'DISCONFORMIDAD CON CRITERIOS ECONÓMICOS / COBROS'),
    ('19', u'DISCONFORMIDAD CON CRITERIOS TÉCNICOS / OBRA EJECUTADA'),
    ('20', u'CALIDAD DE ONDA'),
    ('21', u'CON PETICIÓN DE INDEMNIZACIÓN'),
    ('22', u'SIN PETICIÓN DE INDEMNIZACIÓN'),
    ('23', u'RETRASO EN PAGO INDEMNIZACION'),
    ('24', u'DAÑOS A TERCEROS POR INSTALACIONES'),
    ('25', u'IMPACTO AMBIENTAL INSTALACIONES'),
    ('26', u'RECLAMACIONES SOBRE INSTALACIONES'),
    ('27', u'DISCONFORMIDAD DESCUENTO SERVICIO INDIVIDUAL'),
    ('28', u'EJECUCIÓN INDEBIDA DE CORTE'),
    ('29', u'RETRASO EN LA ATENCIÓN A RECLAMACIONES'),
    ('30', u'RETRASO PLAZO DE CONTESTACIÓN NUEVOS SUMINISTROS'),
    ('31', u'RETRASO PLAZO DE EJECUCIÓN NUEVO SUMINISTRO'),
    ('32', u'RETRASO REENGANCHE TRAS CORTE'),
    ('34', u'DISCONFORMIDAD CON CONCEPTOS DE CONTRATACIÓN ATR-PEAJE'),
    ('35', u'DISCONFORMIDAD RECHAZO SOLICITUD ATR-PEAJE'),
    ('36', u'PETICIÓN DE REFACTURACIÓN APORTANDO LECTURA'),
    ('37', u'FICHERO XML INCORRECTO'),
    ('38', u'PRIVACIDAD DE LOS DATOS'),
    ('39', u'SOLICITUD DE CERTIFICADO / INFORME DE CALIDAD'),
    ('40', u'SOLICITUD DE DUPLICADO DE FACTURA'),
    ('41', u'SOLICITUD DE ACTUACIÓN SOBRE INSTALACIONES'),
    ('42', u'SOLICITUD DE DESCARGO'),
    ('43', u'PETICIÓN DE PRECINTADO / DESPRECINTADO DE EQUIPOS'),
    ('44', u'PETICIONES CON ORIGEN EN CAMPAÑAS DE TELEGESTIÓN'),
    ('45', u'ACTUALIZACION DIRECCIÓN PUNTO DE SUMINISTRO'),
    ('46', u'CERTIFICADO DE LECTURA'),
    ('47', u'SOLICITUD RECALCULO CCH SIN MODIFICACION CIERRE ATR'),
    ('48', u'PETICIÓN INFORMACIÓN ADICIONAL RECHAZO'),
    ('49', u'FALTA FICHERO MEDIDA'),
    ('55', u'DISCONFORMIDAD SOBRE IMPORTE FACTURADO AUTOCONSUMO'),
    ('56', u'PETICIÓN DESGLOSE IMPORTE A FACTURAR AUTOCONSUMO'),
]
