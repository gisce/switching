...
EXTRA_ATC_R1_SUBTYPES = [
    ...
    ('103', u'DISCONFORMIDAD PRECIOS FACTURADOS O REPERCUTIDOS POR '
         u'LA COMERCIALIZADORA.'),
    ('104', u'DISCONFORMIDAD FRACCIONAMIENTO O GASTOS ESPECIALES COBRADOS.'),
    ('105', u'DISCONFORMIDAD CON EL RECOBRO.'),
    ('106', u'DISCONFORMIDAD CON PENALIZACIÓN POR PRONTA RESOLUCIÓN.'),
    ('107', u'INSUFICIENTE INFORMACIÓN EN EL MOMENTO DE LA CONTRATACIÓN '
         u'(Condiciones contractuales, derecho de desistimiento).'),
    ('108', u'RECLAMACION RESPECTO AL DERECHO DE DESISTIMIENTO.'),
    ('109', u'FACTURACION DE OTROS SERVICIOS TRAS LA CANCELACIÓN DEL '
         u'SUMINISTRO.'),
...
SUBTYPES_R1_ATC = (
    [('0{0}'.format(x['code']), x['name']) for x in SUBTYPES_R101] +
    EXTRA_ATC_R1_SUBTYPES
)
