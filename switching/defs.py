...
SUBTYPES_R1_ATC = [('0{0}'.format(x['code']), x['name']) for x in SUBTYPES_R101] \
                  + \
                  [('058', u'RETRASO EN PLAZO ACEPTACIÓN CAMBIO DE COMERCIALIZADOR.'),
                   ('059', u'RETRASO EN PLAZO ACTIVACIÓN CAMBIO DE COMERCIALIZADOR.'),
                   ('060', u'RETRASO EN PLAZO ACEPTACIÓN MODIFICACIÓN CONTRACTUAL.'),
                   ('061', u'RETRASO EN PLAZO ACTIVACIÓN MODIFICACIÓN CONTRACTUAL.'),
                   ('062', u'RETRASO EN PLAZO ACEPTACIÓN ALTA DE UN NUEVO SUMINISTRO.'),
                   ('063', u'RETRASO EN PLAZO ACTIVACIÓN ALTA DE UN NUEVO SUMINISTRO.'),
                   ('064', u'RETRASO EN PLAZO ACEPTACIÓN DE UNA BAJA DE UN SUMINISTRO.'),
                   ('065', u'RETRASO EN PLAZO ACTIVACIÓN BAJA DE UN SUMINISTRO.'),
                   ('100', u'INCIDENCIAS CONTRATACIÓN BONO SOCIAL.'),
                   ('101', u'DATOS BANCARIOS/FORMA DE PAGO ERRÓNEA.'),
                   ('102', u'ERRORES EN COBROS/ ABONOS.'),
                   ('103', u'DISCONFORMIDAD PRECIOS FACTURADOS O REPERCUTIDOS POR LA COMERCIALIZADORA.'),
                   ('104', u'DISCONFORMIDAD FRACCIONAMIENTO O GASTOS ESPECIALES COBRADOS.'),
                   ('105', u'DISCONFORMIDAD CON EL RECOBRO.'), ('106', u'DISCONFORMIDAD CON PENALIZACIÓN POR PRONTA RESOLUCIÓN.'),
                   ('107', u'INSUFICIENTE INFORMACIÓN EN EL MOMENTO DE LA CONTRATACIÓN (Condiciones contractuales, derecho de desistimiento).'),
                   ('108', u'RECLAMACION RESPECTO AL DERECHO DE DESISTIMIENTO.'),
                   ('109', u'FACTURACION DE OTROS SERVICIOS TRAS LA CANCELACIÓN DEL SUMINISTRO.'),
                   ('110', u'FALTA DE CLARIDAD EN LAS FACTURAS.'),
                   ('111', u'FALTA DE CLARIDAD EN LAS CONDICIONES CONTRACTUALES.'),
                   ('112', u'DIFICULTAD EN LA CONTRATACIÓN DE LA TUR/PVPC CON EL CUR/COR.'),
                   ('113', u'RECLAMACIONES POR PRACTICAS COMERCIALES INCORRECTAS.'),
                   ('114', u'RETRASO EN FACTURACIÓN COMERCIALIZADOR.'), ]
